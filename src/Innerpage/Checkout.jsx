...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const razorpayOrderId = data.razorpayResponce.order_id;
      const razorpayOid = data.data.orderID;

      if (data.Status === "Success") {
        const paymentOptions = {
          key: "rzp_live_ZXIWFlbRMILH8q", // Replace with your Razorpay key
              ...
              const logPaymentStatus = async () => {
                try {
                  const response = await axios.post(`${apiUrl}/paymentstatus`, {
                    ...
                    order_id: razorpayOid, // Use oid received from the checkout API response
                    razorpay_payment_id: razorpayPaymentId,
                    razorpay_order_id: razorpayOrderIdReceived,
