...
function Checkout() {
  ...
  const [cartSubtotal, setCartSubtotal] = useState(
    cart.reduce((total, item) => {
      ...
      // Return total directly (price inclusive of GST in your case)
      return total + price * quantity;
    }, 0)
  );
  ...
  // GST calculations
  const gstRate = 18;
  const gstAmount = (cartSubtotal * gstRate) / 118; // GST portion of the subtotal
  const subtotalExcludingGst = cartSubtotal - gstAmount; // Subtotal before GST

  // Logs for testing
  console.log("Subtotal (Excluding GST): ₹", subtotalExcludingGst.toFixed(2));
  console.log("GST Amount: ₹", gstAmount.toFixed(2));
  console.log("Total After GST: ₹", cartSubtotal.toFixed(2));
    ...
    try {
      ...
      if (data.Status === "Success") {
        const paymentOptions = {
          ...
          amount: Math.round(totalAmount * 100), // Amount in paise (INR)
          currency: "INR",
          name: "QR Genie",
                ...
                >
                  ...
                  <div className="subtotal-section">
                    <div className="d-flex justify-content-between">
                      ...
                      <strong>₹ {subtotalExcludingGst.toFixed(2)}</strong>
                    </div>
